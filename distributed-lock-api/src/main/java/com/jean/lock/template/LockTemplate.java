...
public interface LockTemplate<T extends Lock> {
     ...
     */
    <R> R lock(String lockName, long timeout, TimeUnit timeUnit, LockWorker<R> lockWorker);
     ...
     * @throws com.jean.lock.exception.UnableToAcquireLockException 无法加锁
     */
    <R> R tryLock(String lockName, long waitTime, long timeout, TimeUnit timeUnit, LockWorker<R> lockWorker);
